          ...
          <ul className="list-content">
            {itemList.map((item) => (
              <li className="item" key={item.get('id')}>
                ...
                <p className="price">
                  <span className="first-price">¥{item.get('retailPrice')}</span>
                  {item.get('counterPrice') && <span className="seconde-price">¥{item.get('counterPrice')}</span>}
                </p>
              </li>
            ))}
          </ul>
